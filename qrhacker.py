...
░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝
      b
      8b,    {}'''.format("QRHACKER ~ v"+qr_version+" ~ by h0nus\n")
print(banner)
...
parser = argparse.ArgumentParser(description="Tool to generate Malformed QRCodes for fuzzing QRCode parsers/reader",
                                 usage='''qrhacker.py -l [number]\nusage: qrhacker.py -w [/path/to/custom/wordlist]\n\nPayload lists:
0 : SQL Injections
1 : XSS
2 : Command Injection
3 : Format String
...
sgroup = parser.add_argument_group("Options for qrhacker")
...
print("Thanks for using qrhacker, made by H0nus..")
